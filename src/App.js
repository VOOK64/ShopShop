...
//         return (
//             <ul>
//                 {this.props.list.map(function(GetGamesEurope){
//                     return <li>{GetGamesEurope}</li>
//                 })}
//             </ul>
//         )
//     }
...
// var GetGamesEurope2 = createReactClass({displayName: "ProperListRender",
// render: function() {
//   return (
//     React.createElement("ul", null,
//       this.list.map(function(GetGamesEurope){
//         return React.createElement("li", null, GetGamesEurope);
//       })
//     )
//   )
// }
